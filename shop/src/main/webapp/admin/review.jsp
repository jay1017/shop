<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="shop.admin.ReviewDTO" %>
							...
							<div class="col-12 col-lg-8 col-xxl-9 d-flex">
								<div class="card flex-fill">
									<div class="card-header">
										<h5 class="card-title mb-0">리뷰 목록</h5>
									</div>
									<% if(count == 0) { %>
											...
											<tbody>
												<% for(ReviewDTO dto : list) { %>
													<tr>
														...
														<td class="ps-3"><%=dto.getRcontent() %></td>
														<td class="ps-0">
															<button class="btn btn-success" onclick="location.href='/shop/admin/reviewDelete.jsp?rnum=<%=dto.getRnum() %>'">삭제</button>
														</td>
													</tr>
												<% } %>	
											</tbody>
