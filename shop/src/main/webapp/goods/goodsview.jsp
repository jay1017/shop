                            ...
                            <div class="product__details__option">
                                <div class="product__details__option__size">
                                    ...
                                    <label id="<%=dto.getGosize()%>"><%=dto.getGosize()%> 
                                        <input type="radio" name="gonumRadio" id="<%=dto.getGosize()%>" value="<%=dto.getGonum()%>" onclick="selectRadio(this.value)">
                                    </label>
                                    <%
                                    }
                                    %>
                                        ...
                                        <div class="product__details__tab__content__item">
                                                ...
                                                <div id="reviewForm" style="display: none;">
                                                    <form action="/shop/review/reviewPro.jsp" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="rcontent" id="rcontent" rows="4" placeholder="상품에 대한 리뷰를 작성해주세요." required></textarea>
                                                        </div>

                                                        <div class="form-group" style="text-align: right; margin-top: 15px;">
                                                            <button type="button" class="btn btn-secondary btn-sm" onclick="cancelReviewForm()">취소</button>
                                                            <button type="submit" class="btn btn-primary btn-sm" style="margin-left: 10px;">리뷰 등록</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="login-notice" style="margin-bottom: 20px; padding: 15px; background-color: #f8f9fa; border-radius: 5px;">
                                                <p style="margin: 0; color: #6c757d;">
                                                    <i class="fa fa-user"></i> 리뷰를 작성하려면 <a href="/shop/member/loginForm.jsp" style="color: #007bff;">로그인</a>이 필요합니다.
                                                </p>
                                            </div>
                                            <%
                                            }
