    ...
    <%
        for (GoodsDTO p : list) {
            ...
            switch(p.getCategory()) {
                case "new": categoryClass = "new-arrivals"; break;
                case "hot": categoryClass = "hot-sales"; break;
                case "best": categoryClass = ""; break; // 'best'는 기본으로 출력
            }
    %>
    <div class="col-lg-3 col-md-6 col-sm-6 mix <%= categoryClass %>">
        <div class="product__item">
            <div class="product__item__pic set-bg" data-setbg="<%= p.getImage() %>">
                <% if (p.getCategory().equals("new")) { %>
                    <span class="label">New</span>
                <% } else if (p.getCategory().equals("hot")) { %>
                    <span class="label">Hot</span>
                <% } else if (p.getCategory().equals("sale")) { %>
            ...
            <div class="product__item__text">
                ...
                <div class="product__color__select">
                    <label for="pc-<%= p.getId() %>a"><input type="radio" id="pc-<%= p.getId() %>a"></label>
                    <label class="active black" for="pc-<%= p.getId() %>b"><input type="radio" id="pc-<%= p.getId() %>b"></label>
                    <label class="grey" for="pc-<%= p.getId() %>c"><input type="radio" id="pc-<%= p.getId() %>c"></label>
                </div>
            </div>
        </div>
    </div>
